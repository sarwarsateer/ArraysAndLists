...
public class Demo {
    public static void main(String[] args) {
        ...
        addInOrder(citiesToVisit, "kabul");
        addInOrder(citiesToVisit, "Mazar");
        addInOrder(citiesToVisit, "Kunduz");
        addInOrder(citiesToVisit, "Kandahar");
        addInOrder(citiesToVisit, "Helmand");
//        printList(citiesToVisit);

        addInOrder(citiesToVisit, "Baghlan");
//        printList(citiesToVisit);
        visit(citiesToVisit);
